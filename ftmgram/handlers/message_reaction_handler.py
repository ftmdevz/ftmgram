...
class MessageReactionHandler(Handler):
    ...
    :meth:`~ftmgram.Client.on_message_reaction` decorator.
    ...
    Other parameters:
        ...
        reactions (:obj:`~ftmgram.types.MessageReactionUpdated`):
            The received message reaction update.
    """

    def __init__(
        self,
        callback: Callable[["ftmgram.Client", "types.MessageReactionUpdated"], Any],
        filters=None,
    ):
