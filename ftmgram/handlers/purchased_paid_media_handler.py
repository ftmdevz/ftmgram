...
class PurchasedPaidMediaHandler(Handler):
    ...
    :meth:`~ftmgram.Client.on_purchased_paid_media` decorator.
    ...
    Other parameters:
        ...
        update (:obj:`~ftmgram.types.PurchasedPaidMedia`):
            Information about who bought paid media.
    """

    def __init__(
        self,
        callback: Callable[["ftmgram.Client", "types.PurchasedPaidMedia"], Any],
        filters=None,
    ):
