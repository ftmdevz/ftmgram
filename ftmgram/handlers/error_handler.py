...
class ErrorHandler(Handler):
    ...
    :meth:`~ftmgram.Client.on_error` decorator.
    ...
    Other parameters passed to the callback:
        ...
        handler (:obj:`~ftmgram.handlers.handler.Handler`):
            The Handler instance from which the exception was raised.

        update (:obj:`~ftmgram.raw.base.Update`):
            The received update, which can be one of the many single Updates listed in the
            :obj:`~ftmgram.raw.base.Update` base type.

        users (``dict``):
            Dictionary of all :obj:`~ftmgram.raw.base.User` mentioned in the update.
            You can access extra info about the user (such as *first_name*, *last_name*, etc...) by using
            the IDs you find in the *update* argument (e.g.: *users[1768841572]*).

        chats (``dict``):
            Dictionary of all :obj:`~ftmgram.raw.base.Chat` mentioned in the update.
