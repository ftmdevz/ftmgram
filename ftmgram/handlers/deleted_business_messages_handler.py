...
class DeletedBusinessMessagesHandler(Handler):
    ...
    :meth:`~ftmgram.Client.on_deleted_business_messages` decorator.
    ...
    def __init__(
        self,
        callback: Callable[["ftmgram.Client", List["types.Message"]], Any],
        filters: Filter = None,
    ):
        super().__init__(callback, filters)

    async def check(self, client: "ftmgram.Client", messages: List["types.Message"]):
