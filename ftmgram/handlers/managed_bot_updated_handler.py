...
class ManagedBotUpdatedHandler(Handler):
    ...
    For a nicer way to register this handler, have a look at the :meth:`~ftmgram.Client.on_managed_bot` decorator.
    ...
    Other parameters:
        ...
        managed_bot_updated (:obj:`~ftmgram.types.ManagedBotUpdated`):
            A new bot was created to be managed by the bot or token of a bot was changed.
    """

    def __init__(
        self, callback: Callable[["ftmgram.Client", "types.ManagedBotUpdated"], Any], filters=None
    ):
