...
class ConnectHandler(Handler):
    ...
    :meth:`~ftmgram.Client.on_connect` decorator.
    ...
    Other parameters:
        ...
        session (:obj:`~ftmgram.session.Session`):
            The Session used for the connection.
    """

    def __init__(self, callback: Callable[["ftmgram.Client", "ftmgram.session.Session"], Any]):
