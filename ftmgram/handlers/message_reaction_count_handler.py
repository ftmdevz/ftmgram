...
class MessageReactionCountHandler(Handler):
    ...
    :meth:`~ftmgram.Client.on_message_reaction_count` decorator.
    ...
    Other parameters:
        ...
        reactions (:obj:`~ftmgram.types.MessageReactionCountUpdated`):
            The received message reaction count update.
    """

    def __init__(
        self,
        callback: Callable[["ftmgram.Client", "types.MessageReactionCountUpdated"], Any],
        filters=None,
    ):
