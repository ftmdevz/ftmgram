...
class ComposedMessageWithAI(TLObject):
    ...
    Constructor of :obj:`~ftmgram.raw.base.messages.ComposedMessageWithAI`.
    ...
    Parameters:
        result_text (:obj:`TextWithEntities <ftmgram.raw.base.TextWithEntities>`):
            N/A

        diff_text (:obj:`TextWithEntities <ftmgram.raw.base.TextWithEntities>`, *optional*):
            N/A
