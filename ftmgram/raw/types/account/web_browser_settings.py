...
class WebBrowserSettings(TLObject):
    ...
    Constructor of :obj:`~ftmgram.raw.base.account.WebBrowserSettings`.
    ...
    Parameters:
        external_exceptions (List of :obj:`WebDomainException <ftmgram.raw.base.WebDomainException>`):
            N/A

        inapp_exceptions (List of :obj:`WebDomainException <ftmgram.raw.base.WebDomainException>`):
            N/A
