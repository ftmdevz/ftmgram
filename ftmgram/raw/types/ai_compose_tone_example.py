...
class AiComposeToneExample(TLObject):
    ...
    Constructor of :obj:`~ftmgram.raw.base.AiComposeToneExample`.
    ...
    Parameters:
        from_peer (:obj:`TextWithEntities <ftmgram.raw.base.TextWithEntities>`):
            N/A

        to (:obj:`TextWithEntities <ftmgram.raw.base.TextWithEntities>`):
            N/A
