...
class SentCode(Object):
    ...
    Parameters:
        ...
        next_type (:obj:`~ftmgram.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~ftmgram.Client.resend_phone_number_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~ftmgram.Client.resend_phone_number_code`.
    """
