...
class KeyboardButtonRequestChat(Object):
    ...
    Parameters:
        ...
        user_administrator_rights (:obj:`~ftmgram.types.ChatAdministratorRights`, *optional*):
            Privileged actions that an user administrator is able to take.

        bot_administrator_rights (:obj:`~ftmgram.types.ChatAdministratorRights`, *optional*):
