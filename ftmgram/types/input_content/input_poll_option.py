...
class InputPollOption(Object):
    ...
    Parameters:
        text (``str`` | :obj:`~ftmgram.enums.FormattedText`, *optional*):
            Option text, 1-100 characters.

        media (:obj:`~ftmgram.types.InputPollOptionMedia`, *optional*):
            Option media.
    ...
    async def write(self, client: "ftmgram.Client") -> "raw.types.InputPollAnswer":
