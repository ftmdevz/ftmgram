...
class InputChatPhoto(Object):
    ...
    - :obj:`~ftmgram.types.InputChatPhotoPrevious`
    - :obj:`~ftmgram.types.InputChatPhotoStatic`
    - :obj:`~ftmgram.types.InputChatPhotoAnimation`
    """
    # TODO: - :obj:`~ftmgram.types.InputChatPhotoSticker`
    ...
    async def write(self, client: "ftmgram.Client") -> "raw.base.InputFile":
...
class InputChatPhotoPrevious(InputChatPhoto):
    ...
    async def write(self, client: "ftmgram.Client") -> "raw.types.InputPhoto":
