...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        top_message (:obj:`~ftmgram.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "ftmgram.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
        if not forum_topic:
            return None
