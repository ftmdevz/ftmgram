...
class UpgradedGiftAttributeRarity(Object):
    ...
    It can be one of:
    - :obj:`~ftmgram.types.UpgradedGiftAttributeRarityPerMille`
    - :obj:`~ftmgram.types.UpgradedGiftAttributeRarityUncommon`
    - :obj:`~ftmgram.types.UpgradedGiftAttributeRarityRare`
    - :obj:`~ftmgram.types.UpgradedGiftAttributeRarityEpic`
    - :obj:`~ftmgram.types.UpgradedGiftAttributeRarityLegendary`
    """
