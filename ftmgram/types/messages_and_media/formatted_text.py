...
class FormattedText(Object):
    ...
    Parameters:
        ...
        parse_mode (:obj:`~ftmgram.types.ParseMode`, *optional*):
    ...
    @staticmethod
    def _parse(client: "ftmgram.Client", text: "raw.types.TextWithEntities") -> "FormattedText":
    ...
    async def write(self, client: "ftmgram.Client") -> "raw.types.TextWithEntities":
        message, entities = (
