...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        question (:obj:`~ftmgram.types.FormattedText`, *optional*):
        ...
        explanation (:obj:`ftmgram.types.FormattedText`, *optional*):
            Text that is shown when a user chooses an incorrect answer or taps on the lamp icon in a quiz-style poll,
            0-200 characters.

        explanation_media (:obj:`~ftmgram.types.MessageContent`, *optional*):
        ...
        description (:obj:`~ftmgram.types.FormattedText`, *optional*):
            Description of the poll.
            Only for polls inside the :obj:`~ftmgram.types.Message` object.

        description_media (:obj:`~ftmgram.types.MessageContent`, *optional*):
            Media attached to the poll.
            Only for polls inside the :obj:`~ftmgram.types.Message` object.

        voter (:obj:`~ftmgram.types.User`, *optional*):
