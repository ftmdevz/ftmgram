...
class MessageReactions(Object):
    ...
    Parameters:
        ...
        paid_reactors (List of :obj:`~ftmgram.types.PaidReactor`, *optional*):
            Information about top users that added the paid reaction.

        can_get_added_reactions (``bool``, *optional*):
            True, if the list of added reactions is available using :meth:`~ftmgram.Client.get_message_added_reactions`.
    """
