...
class RichText(Object):
    ...
    - ``str``
    - List of :obj:`~ftmgram.types.RichText`
    - :obj:`~ftmgram.types.RichTextBold`
    - :obj:`~ftmgram.types.RichTextItalic`
    - :obj:`~ftmgram.types.RichTextUnderline`
    - :obj:`~ftmgram.types.RichTextStrikethrough`
    - :obj:`~ftmgram.types.RichTextSpoiler`
    - :obj:`~ftmgram.types.RichTextDateTime`
    - :obj:`~ftmgram.types.RichTextTextMention`
    - :obj:`~ftmgram.types.RichTextSubscript`
    - :obj:`~ftmgram.types.RichTextSuperscript`
    - :obj:`~ftmgram.types.RichTextMarked`
    - :obj:`~ftmgram.types.RichTextCode`
    - :obj:`~ftmgram.types.RichTextCustomEmoji`
    - :obj:`~ftmgram.types.RichTextMathematicalExpression`
    - :obj:`~ftmgram.types.RichTextUrl`
    - :obj:`~ftmgram.types.RichTextEmailAddress`
    - :obj:`~ftmgram.types.RichTextPhoneNumber`
    - :obj:`~ftmgram.types.RichTextBankCardNumber`
    - :obj:`~ftmgram.types.RichTextMention`
    - :obj:`~ftmgram.types.RichTextHashtag`
    - :obj:`~ftmgram.types.RichTextCashtag`
    - :obj:`~ftmgram.types.RichTextBotCommand`
    - :obj:`~ftmgram.types.RichTextAnchor`
    - :obj:`~ftmgram.types.RichTextAnchorLink`
    - :obj:`~ftmgram.types.RichTextReference`
    - :obj:`~ftmgram.types.RichTextReferenceLink`
    """
