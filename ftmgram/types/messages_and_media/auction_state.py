...
class AuctionState(Object):
    ...
    - :obj:`~ftmgram.types.AuctionStateActive`
    - :obj:`~ftmgram.types.AuctionStateFinished`
    """
...
class AuctionStateActive(AuctionState):
    ...
    Parameters:
        ...
        bid_levels (List of :obj:`~ftmgram.types.AuctionBid`):
        ...
        rounds (List of :obj:`~ftmgram.types.AuctionRound`):
