...
class GiftAuctionState(Object):
    ...
    Parameters:
        gift (:obj:`~ftmgram.types.Gift`):
            The gift.

        state (:obj:`~ftmgram.types.AuctionState`):
            Auction state of the gift.

        raw (:obj:`~ftmgram.raw.base.StarGiftAuctionState`, *optional*):
    ...
    @staticmethod
    async def _parse(
        client: "ftmgram.Client", gift_auction_state: "raw.base.StarGiftAuctionState"
    ) -> "GiftAuctionState":
        state = None
