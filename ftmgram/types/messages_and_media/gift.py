...
class Gift(Object):
    ...
    Parameters:
        ...
        type (:obj:`~ftmgram.enums.GiftType`):
            Type of the gift.

        origin (:obj:`~ftmgram.enums.UpgradedGiftOrigin`, *optional*):
            Origin of the gift.
        ...
        publisher_chat (:obj:`~ftmgram.types.Chat`, *optional*):
            Information about the chat that published the gift.

        sticker (:obj:`~ftmgram.types.Sticker`, *optional*):
            The sticker that represents the gift.

        text (:obj:`~ftmgram.types.FormattedText`, *optional*):
        ...
        sender (:obj:`~ftmgram.types.Chat`, *optional*):
            User or a chat that sent the gift.

        receiver (:obj:`~ftmgram.types.Chat`, *optional*):
            User or a chat that received the gift.

        host (:obj:`~ftmgram.types.Chat`, *optional*):
            User or the chat to which the upgraded gift was assigned from blockchain.

        owner (:obj:`~ftmgram.types.Chat`, *optional*):
        ...
        model (:obj:`~ftmgram.types.GiftAttribute`, *optional*):
            Model of the upgraded gift.

        symbol (:obj:`~ftmgram.types.GiftAttribute`, *optional*):
            Symbol of the upgraded gift.

        backdrop (:obj:`~ftmgram.types.GiftAttribute`, *optional*):
            Backdrop of the upgraded gift.

        original_details (:obj:`~ftmgram.types.UpgradedGiftOriginalDetails`, *optional*):
        ...
        prepaid_upgrade_hash (``str``, *optional*):
            If non-empty, then the user can pay for an upgrade of the gift using :meth:`~ftmgram.Client.buy_gift_upgrade`.

        auction_info (:obj:`~ftmgram.types.GiftAuction`, *optional*):
            Information about the auction on which the gift can be purchased.

        resale_parameters (:obj:`~ftmgram.types.GiftResaleParameters`, *optional*):
            Resale parameters of the gift.

        user_limits (:obj:`~ftmgram.types.GiftPurchaseLimit`, *optional*):
            Number of times the gift can be purchased by the current user.

        overall_limits (:obj:`~ftmgram.types.GiftPurchaseLimit`, *optional*):
        ...
        can_send_purchase_offer (``bool``, *optional*):
            True, if an offer to purchase the gift can be sent using :meth:`~ftmgram.Client.send_gift_purchase_offer`.
        ...
        raw (:obj:`~ftmgram.raw.base.StarGift` | :obj:`~ftmgram.raw.base.SavedStarGift`):
    ...
    async def show(self) -> bool:
        """Bound method *show* of :obj:`~ftmgram.types.Gift`.
    ...
    async def hide(self) -> bool:
        """Bound method *hide* of :obj:`~ftmgram.types.Gift`.
    ...
    async def convert(self) -> bool:
        """Bound method *convert* of :obj:`~ftmgram.types.Gift`.
    ...
    async def upgrade(self, keep_original_details: Optional[bool] = None, star_count: Optional[int] = None) -> Optional["types.Message"]:
        """Bound method *upgrade* of :obj:`~ftmgram.types.Gift`.
    ...
    async def transfer(self, to_chat_id: Union[int, str]) -> Optional["types.Message"]:
        """Bound method *transfer* of :obj:`~ftmgram.types.Gift`.
    ...
    async def wear(self) -> bool:
        """Bound method *wear* of :obj:`~ftmgram.types.Gift`.
    ...
    async def buy(self, new_owner_chat_id: Optional[Union[int, str]] = None, price: Optional["types.GiftResalePrice"] = None) -> Optional["types.Message"]:
        """Bound method *buy* of :obj:`~ftmgram.types.Gift`.
    ...
    async def send(
        ...
        """Bound method *send* of :obj:`~ftmgram.types.Gift`.
    ...
    async def get_auction_state(self) -> "types.GiftAuctionState":
        """Bound method *get_auction_state* of :obj:`~ftmgram.types.Gift`.
        ...
        Returns:
            :obj:`~ftmgram.types.GiftAuctionState`: The auction state of the gift.
        """
    ...
    async def send_purchase_offer(
        ...
        """Shortcut for method :obj:`~ftmgram.Client.send_gift_purchase_offer` will automatically fill method attributes:

        * owner_id
        * gift_id

        Parameters:
            price (:obj:`~ftmgram.types.GiftResalePrice`):
