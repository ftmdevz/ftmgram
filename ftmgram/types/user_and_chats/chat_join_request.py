...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        ...
        query_id (``str``, *optional*):
            ...
            If present, then the bot must call :meth:`~ftmgram.Client.send_chat_join_request_web_app`
            or directly call :meth:`~ftmgram.Client.answer_chat_join_request_query` within 10 seconds.
    """
