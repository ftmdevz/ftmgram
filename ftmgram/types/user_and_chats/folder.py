...
class Folder(Object):
    ...
    Parameters:
        ...
        color (:obj:`~ftmgram.enums.FolderColor`, *optional*)
        ...
        pinned_chats (List of :obj:`~ftmgram.types.Chat`, *optional*):
        ...
        included_chats (List of :obj:`~ftmgram.types.Chat`, *optional*):
            The always included chats in the folder.
            There can be up to getOption("chat_folder_chosen_chat_count_max") pinned and always included non-secret chats and the same number of secret chats, but the limit can be increased with Telegram Premium.

        excluded_chats (List of :obj:`~ftmgram.types.Chat`, *optional*):
    ...
    @staticmethod
    async def _parse(client: "ftmgram.Client", folder: "raw.base.DialogFilter", users, chats) -> Optional["Folder"]:
        if not folder:
            return
    ...
    async def delete(self) -> bool:
        """Bound method *delete* of :obj:`~ftmgram.types.Folder`.
    ...
    async def edit(
        ...
        """Bound method *update_peers* of :obj:`~ftmgram.types.Folder`.
    ...
    async def include_chat(self, chat_id: Union[int, str]) -> bool:
        """Bound method *include_chat* of :obj:`~ftmgram.types.Folder`.
    ...
    async def exclude_chat(self, chat_id: Union[int, str]) -> bool:
        """Bound method *exclude_chat* of :obj:`~ftmgram.types.Folder`.
    ...
    async def pin_chat(self, chat_id: Union[int, str]):
        """Bound method *pin_chat* of :obj:`~ftmgram.types.Folder`.
    ...
    async def remove_chat(self, chat_id: Union[int, str]):
        """Bound method *remove_chat* of :obj:`~ftmgram.types.Folder`.
    ...
    async def update_color(self, color: "enums.FolderColor"):
        """Bound method *update_color* of :obj:`~ftmgram.types.Folder`.
        ...
        Parameters:
            color (:obj:`~ftmgram.enums.FolderColor`, *optional*):
                Color type.
                Pass :obj:`~ftmgram.enums.FolderColor` to set folder color.
    ...
    async def create_invite_link(self, name: str = None, chat_ids: List[Union[int, str]] = None) -> "types.FolderInviteLink":
        """Bound method *create_invite_link* of :obj:`~ftmgram.types.Folder`.
        ...
        Returns:
            :obj:`~ftmgram.types.FolderInviteLink`: On success, information about the invite link is returned.
        """
        if chat_ids is None:
