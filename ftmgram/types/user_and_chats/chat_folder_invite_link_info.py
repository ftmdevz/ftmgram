...
class ChatFolderInviteLinkInfo(Object):
    ...
    @staticmethod
    async def _parse(
        client: "ftmgram.Client", invite: "raw.base.chatlists.ChatlistInvite"
