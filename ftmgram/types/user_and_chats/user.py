...
class User(Object, Update):
    ...
    Parameters:
        ...
        can_join_groups (``bool``, *optional*):
            True, if the bot can be invited to groups. Returned only in :meth:`~ftmgram.Client.get_me`.

        can_read_all_group_messages (``bool``, *optional*):
            True, if privacy mode is disabled for the bot. Returned only in :meth:`~ftmgram.Client.get_me`.
        ...
        can_manage_bots (``bool``, *optional*):
            True, if other bots can be created to be controlled by the bot. Returned only in :meth:`~ftmgram.Client.get_me`.

        has_main_web_app (``bool``, *optional*):
            True, if the bot has a main Web App. Returned only in :meth:`~ftmgram.Client.get_me`.
        ...
        settings (:obj:`~ftmgram.types.ChatSettings`, *optional*):
            Chat settings.
            Returned only in :meth:`~ftmgram.Client.get_me`.
        ...
        raw (:obj:`~ftmgram.raw.base.User` | :obj:`~ftmgram.raw.base.UserStatus`, *optional*):
