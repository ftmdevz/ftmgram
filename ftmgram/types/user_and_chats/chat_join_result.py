...
class ChatJoinResult(Object):
    ...
    - :obj:`~ftmgram.types.ChatJoinResultSuccess`
    - :obj:`~ftmgram.types.ChatJoinResultRequestSent`
    - :obj:`~ftmgram.types.ChatJoinResultGuardBotApprovalRequired`
    - :obj:`~ftmgram.types.ChatJoinResultDeclined`
    """
