...
from ftmgram import types, utils, enums
...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        created_forum_topic (:obj:`~ftmgram.types.ForumTopic`, *optional*):
            New forum topic.
            For :obj:`~ftmgram.enums.ChatEvenAction.CREATED_FORUM_TOPIC` action only.

        old_forum_topic, new_forum_topic (:obj:`~ftmgram.types.ForumTopic`, *optional*):
            Edited forum topic.
            For :obj:`~ftmgram.enums.ChatEvenAction.EDITED_FORUM_TOPIC` action only.

        deleted_forum_topic (:obj:`~ftmgram.types.ForumTopic`, *optional*):
            Deleted forum topic.
            For :obj:`~ftmgram.enums.ChatEvenAction.DELETED_FORUM_TOPIC` action only.
    """
