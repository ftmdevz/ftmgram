...
class Chat(Object):
    ...
    Parameters:
        ...
        verification_status (:obj:`~ftmgram.types.VerificationStatus`, *optional*):
            Contains information about verification status of a chat.

        can_send_gift (``bool``, *optional*):
            True, if the user can send a gift to the supergroup or channel using :meth:`~ftmgram.Client.send_gift` or :meth:`~ftmgram.Client.transfer_gift`.
        ...
        usernames (List of :obj:`~ftmgram.types.Username`, *optional*):
        ...
        personal_photo (:obj:`~ftmgram.types.ChatPhoto`, *optional*):
        ...
        public_photo (:obj:`~ftmgram.types.ChatPhoto`, *optional*):
            Chat profile photo visible if the main photo is hidden by privacy settings.
            This photo isn't returned in the list of chat photos.
            Suitable for downloads only.

        stories (List of :obj:`~ftmgram.types.Story`, *optional*):
            The list of chat's stories if available.

        chat_background (:obj:`~ftmgram.types.ChatBackground`, *optional*):
            Chat wallpaper.
        ...
        personal_channel (:obj:`~ftmgram.types.Chat`, *optional*):
            The personal channel linked to this chat.
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        personal_channel_message (:obj:`~ftmgram.types.Message`, *optional*):
        ...
        bot_verification (:obj:`~ftmgram.types.BotVerification`, *optional*):
            Information about bot verification.

        main_profile_tab (:obj:`~ftmgram.enums.ProfileTab`, *optional*):
            The main tab chosen by the administrators of the channel.
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        first_profile_audio (:obj:`~ftmgram.types.Audio`, *optional*):
            The first audio file added to the user's profile.
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        rating (:obj:`~ftmgram.types.UserRating`, *optional*):
            Description of the current rating of the user.

        pending_rating (:obj:`~ftmgram.types.UserRating`, *optional*):
        ...
        settings (:obj:`~ftmgram.types.ChatSettings`, *optional*):
            Chat settings.
            Returned only in :meth:`~ftmgram.Client.get_chat`.
        ...
        channel_admin_rights (:obj:`~ftmgram.types.ChatAdministratorRights`, *optional*):
            A suggested set of administrator rights for the bot, to be shown when adding the bot as admin to a channel.
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        chat_admin_rights (:obj:`~ftmgram.types.ChatAdministratorRights`, *optional*):
        ...
        theme (:obj:`~ftmgram.types.ChatTheme`, *optional*):
        ...
        accepted_gift_types (:obj:`~ftmgram.types.AcceptedGiftTypes`, *optional*):
            Information about gifts that can be received by the user.
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        note (:obj:`~ftmgram.types.FormattedText`, *optional*):
            Note added to the user's contact.
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        guard_bot (:obj:`~ftmgram.types.User`, *optional*):
            The bot that processes join request queries in the chat.
            The field is only available to chat administrators
            Returned only in :meth:`~ftmgram.Client.get_chat`.

        raw (:obj:`~ftmgram.raw.types.UserFull` | :obj:`~ftmgram.raw.types.ChatFull` | :obj:`~ftmgram.raw.types.ChannelFull`, *optional*):
    ...
    @staticmethod
    async def _parse_full(client: "ftmgram.Client", chat_full: Union["raw.types.UserFull", "raw.types.ChatFull", "raw.types.ChannelFull"]) -> Optional["Chat"]:
    ...
    async def set_ttl(self, ttl_seconds: int) -> "types.Message":
        """Bound method *set_ttl* of :obj:`~ftmgram.types.Chat`.
    ...
    async def promote_member(
        ...
        Parameters:
            ...
            privileges (:obj:`~ftmgram.types.ChatAdministratorRights`, *optional*):
                New user privileges.
    ...
    async def add_members(
        ...
        Returns:
            List of :obj:`~ftmgram.types.FailedToAddMember`: On success, an empty list is returned, otherwise a list of :obj:`~ftmgram.types.FailedToAddMember` is returned.
        """
    ...
    async def mute(self, mute_until: datetime = None) -> bool:
        """Bound method *mute* of :obj:`~ftmgram.types.Chat`.
    ...
    async def unmute(self) -> bool:
        """Bound method *unmute* of :obj:`~ftmgram.types.Chat`.
