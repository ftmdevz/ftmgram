...
class Filter:
    async def __call__(self, client: "ftmgram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            For example, in a :obj:`~ftmgram.handlers.MessageHandler` the *update* argument will be a :obj:`~ftmgram.types.Message`; in a :obj:`~ftmgram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~ftmgram.types.CallbackQuery`.
...
"""Filter messages that contain :obj:`~ftmgram.types.GiveawayWinners` objects."""
...
"""Filter messages that contain :obj:`~ftmgram.types.Gift` objects."""
...
"""Filter messages that contain :obj:`~ftmgram.types.Location` objects with a live period."""
...
"""Filter messages that contain :obj:`~ftmgram.types.Story` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Optional[Union[str, List[str]]] = "/", case_sensitive: bool = False):
    ...
    async def func(flt, client: ftmgram.Client, message: Message):
