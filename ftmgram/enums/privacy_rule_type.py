...
class PrivacyRuleType(AutoName):
    """Privacy rule type enumeration used in :obj:`~ftmgram.types.PrivacyRule`."""
    ...
    "Allow only users with a Premium subscription. Currently only usable for :obj:`~ftmgram.enums.PrivacyKey.CHAT_INVITE`."
