...
class PaidReactionPrivacy(AutoName):
    """Reaction privacy type enumeration used in :meth:`~ftmgram.Client.send_paid_reaction`."""
    ...
    "Send reaction as specific chat. You can get all available chats in :meth:`~ftmgram.Client.get_send_as_chats`"
