...
from typing import BinaryIO, Callable, List, Optional, Set, Union
...
class SendVideoNote:
    async def send_video_note(
        ...
        caption: str = "",
        caption_parse_mode: Optional["enums.ParseMode"] = None,
        ...
        Parameters:
            ...
            caption (``str``, *optional*):
                Video note caption, 0-1024 characters.

            caption_parse_mode (:obj:`~ftmgram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            caption_entities (List of :obj:`~ftmgram.types.MessageEntity`):
                List of special entities that appear in the caption, which can be specified instead of *caption_parse_mode*.
                ...
                try:
                    ...
                    r = await self.invoke(
                        raw.functions.messages.SendMedia(
                            ...
                            effect=message_effect_id or effect_id,
                            **await utils.parse_text_entities(self, caption, caption_parse_mode, caption_entities),
                        ),
