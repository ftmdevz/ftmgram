...
class GetWebAppUrl:
    async def get_web_app_url(
        ...
        a :obj:`~ftmgram.types.KeyboardButton` button with web app type,
        or an :obj:`~ftmgram.types.InlineKeyboardButton` button with web app type.
        ...
        Parameters:
            ...
            url (``str``, *optional*):
                The URL from :obj:`~ftmgram.types.KeyboardButton` button with web app type,
                or an :obj:`~ftmgram.types.InlineKeyboardButton` button with web app type,
