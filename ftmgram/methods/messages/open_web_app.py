...
class OpenWebApp:
    async def open_web_app(
        ...
        """Informs ftmgram that a Web App is being opened from the attachment menu,
        a :obj:`~ftmgram.types.MenuButton`, an url,
        or an :obj:`~ftmgram.types.InlineKeyboardButton` button.
        ...
        Parameters:
            ...
            url (``str``, *optional*):
                The URL from an :obj:`~ftmgram.types.InlineKeyboardButton` or a :obj:`~ftmgram.types.MenuButton`.
            ...
            platform (:obj:`~ftmgram.enums.ClientPlatform`, *optional*):
