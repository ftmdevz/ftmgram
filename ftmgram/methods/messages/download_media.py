...
class DownloadMedia:
    ...
    async def download_media(
        ...
        Parameters:
            message (``str`` | :obj:`~ftmgram.types.Message` | :obj:`~ftmgram.types.Story` | :obj:`~ftmgram.types.Audio` | :obj:`~ftmgram.types.Document` | :obj:`~ftmgram.types.Photo` | :obj:`~ftmgram.types.Sticker` | :obj:`~ftmgram.types.Animation` | :obj:`~ftmgram.types.Video` | :obj:`~ftmgram.types.Voice` | :obj:`~ftmgram.types.VideoNote` | :obj:`~ftmgram.types.PaidMediaInfo` | :obj:`~ftmgram.types.Thumbnail` | :obj:`~ftmgram.types.StrippedThumbnail` | :obj:`~ftmgram.types.PaidMediaPreview`):
