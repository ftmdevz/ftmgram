    ...
    async def unban_chat_sender_chat(
        ...
        Parameters:
            ...
            sender_chat_id (``int`` | ``str``):
                Unique identifier (int) or username (str) of the target sender chat to unban.
        ...
        if isinstance(peer, raw.types.InputPeerChannel):
            ...
            raise ValueError("unban_chat_sender_chat is only supported for channels and supergroups")
