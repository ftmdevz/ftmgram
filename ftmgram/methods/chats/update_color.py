...
class UpdateColor:
    async def update_color(
        ...
        Parameters:
            ...
            color (:obj:`~ftmgram.enums.ReplyColor` | :obj:`~ftmgram.enums.ProfileColor`):
                Color type.
                Pass :obj:`~ftmgram.enums.ReplyColor` to set reply color or
                :obj:`~ftmgram.enums.ProfileColor` to set profile color.
