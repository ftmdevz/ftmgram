    ...
    async def set_chat_discussion_group(
        ...
        Example:
            .. code-block:: python
                ...
                await app.set_chat_discussion_group(chat_id="@ftmgram", discussion_chat_id="@ftmgramchat")

                # Remove a discussion group from a channel
                await app.set_chat_discussion_group(chat_id="@ftmgram")

                # Remove a discussion group from a channel
                await app.set_chat_discussion_group(discussion_chat_id="@ftmgramchat")
        """
