...
class JoinChat:
    async def join_chat(
        self: "ftmgram.Client", chat_id: Union[int, str]
        ...
        Returns:
            :obj:`~ftmgram.types.ChatJoinResult`: On success, a chat join result object is returned.
        ...
        Example:
            .. code-block:: python
                ...
                # Join a linked chat
                await app.join_chat((await app.get_chat("ftmgram")).linked_chat.id)
        """
