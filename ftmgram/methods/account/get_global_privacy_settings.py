...
class GetGlobalPrivacySettings:
    async def get_global_privacy_settings(self: "ftmgram.Client") -> "types.GlobalPrivacySettings":
        """Get account global privacy settings.

        .. include:: /_includes/usable-by/users.rst

        Returns:
            :obj:`~ftmgram.types.GlobalPrivacySettings`: On success, the global privacy settings is returned.
