...
class SetPrivacy:
    async def set_privacy(
        ...
        Parameters:
            key (:obj:`~ftmgram.enums.PrivacyKey`):
                Privacy key.

            rules (Iterable of :obj:`~ftmgram.types.InputPrivacyRule`):
                List of privacy rules.

        Returns:
            List of :obj:`~ftmgram.types.PrivacyRule`: On success, the list of privacy rules is returned.
