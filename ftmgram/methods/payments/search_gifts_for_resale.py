...
class SearchGiftsForResale:
    async def search_gifts_for_resale(
        ...
        Parameters:
            ...
            order (:obj:`~ftmgram.enums.GiftForResaleOrder`):
            ...
            attributes (List of :obj:`~ftmgram.types.UpgradedGiftAttributeId`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~ftmgram.types.Gift` objects.
