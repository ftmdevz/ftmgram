...
class SendPaymentForm:
    async def send_payment_form(
        ...
        Parameters:
            payment_form_id (``int``):
                Payment form identifier returned by :meth:`~ftmgram.Client.get_payment_form`.

            input_invoice (:obj:`~ftmgram.types.InputInvoice`):
                The invoice.

            credentials (:obj:`~ftmgram.types.InputCredentials`, *optional*):
