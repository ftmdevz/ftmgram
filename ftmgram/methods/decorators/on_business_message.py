...
class OnBusinessMessage:
    def on_business_message(
        ...
        :obj:`~ftmgram.handlers.BusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.BusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.BusinessMessageHandler(func, self),
