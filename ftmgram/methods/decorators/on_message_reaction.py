...
class OnMessageReaction:
    def on_message_reaction(
        ...
        :obj:`~ftmgram.handlers.MessageReactionHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.MessageReactionHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.MessageReactionHandler(func, self),
