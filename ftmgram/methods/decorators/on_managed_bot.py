...
class OnManagedBot:
    def on_managed_bot(
        ...
        :obj:`~ftmgram.handlers.ManagedBotUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.ManagedBotUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.ManagedBotUpdatedHandler(func, self),
