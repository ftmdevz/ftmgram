...
class OnMessageReactionCount:
    def on_message_reaction_count(
        ...
        :obj:`~ftmgram.handlers.MessageReactionCountHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.MessageReactionCountHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.MessageReactionCountHandler(func, self),
