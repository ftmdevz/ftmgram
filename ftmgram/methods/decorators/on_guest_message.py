...
class OnGuestMessage:
    def on_guest_message(
        ...
        :obj:`~ftmgram.handlers.GuestMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.GuestMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.GuestMessageHandler(func, self),
