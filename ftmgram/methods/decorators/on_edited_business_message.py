...
class OnEditedBusinessMessage:
    def on_edited_business_message(
        ...
        :obj:`~ftmgram.handlers.EditedBusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.EditedBusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.EditedBusinessMessageHandler(func, self),
