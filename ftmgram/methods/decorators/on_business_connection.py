...
class OnBusinessConnection:
    def on_business_connection(
        ...
        :obj:`~ftmgram.handlers.BusinessConnectionHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.BusinessConnectionHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.BusinessConnectionHandler(func, self),
