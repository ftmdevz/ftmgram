...
class OnDeletedBusinessMessages:
    def on_deleted_business_messages(
        ...
        :obj:`~ftmgram.handlers.DeletedBusinessMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, ftmgram.Client):
                self.add_handler(ftmgram.handlers.DeletedBusinessMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        ftmgram.handlers.DeletedBusinessMessagesHandler(func, self),
