...
class SetProfilePhoto:
    async def set_profile_photo(
        ...
        for_my_bot: Optional[bool] = None,
        photo_frame_start_timestamp: Optional[float] = None,
        *,
        ...
        Parameters:
            photo (:obj:`~ftmgram.types.InputChatPhoto`, *optional*):
    ...
    async def set_bot_profile_photo(
        ...
        Example:
            .. code-block:: python
                ...
                await app.set_bot_profile_photo(bot_user_id="@ftmgramBot", photo=types.InputChatPhotoStatic("new_photo.jpg"))

                # Set a new bot profile video
                await app.set_bot_profile_photo(bot_user_id="@ftmgramBot", photo=types.InputChatPhotoAnimation("new_video.mp4"))

                # Remove bot profile photo
                await app.set_bot_profile_photo(bot_user_id="@ftmgramBot")
        """
        if isinstance(photo, types.InputChatPhotoPrevious):
            return bool(
                await self.invoke(
