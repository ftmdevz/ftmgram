...
class ChangePhoneNumber:
    async def change_phone_number(
        self: "ftmgram.Client", phone_number: str, phone_code_hash: str, phone_code: str
    ) -> "types.User":
        ...
        Parameters:
            ...
            phone_code_hash (``str``):
                Code identifier taken from the result of :meth:`~ftmgram.Client.send_phone_number_code`.

            phone_code (``str``):
                The valid confirmation code you received from SMS in your phone number.

        Returns:
            :obj:`~ftmgram.types.User`: On success, in case the change completed, the user is returned.
        """
