...
from ftmgram.errors import NetworkMigrate, PhoneMigrate
...
class SendPhoneNumberCode:
    async def send_phone_number_code(
        ...
        Parameters:
            ...
            settings (:obj:`~ftmgram.types.PhoneNumberAuthenticationSettings`, *optional*):
                Settings for the authentication of the user's phone number.

            type (:obj:`~ftmgram.enums.PhoneNumberCodeType`, *optional*):
        ...
        Returns:
            :obj:`~ftmgram.types.SentCode`: On success, returns information about the sent code.
