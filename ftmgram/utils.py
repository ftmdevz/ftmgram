...
from ftmgram.file_id import DOCUMENT_TYPES, PHOTO_TYPES, FileId, FileType
...
async def get_input_stargift(client: "ftmgram.Client", owned_gift_id: str) -> "raw.base.InputSavedStarGift":
